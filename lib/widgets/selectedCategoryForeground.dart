...
class selectedCategoryForeground extends StatefulWidget {
  const selectedCategoryForeground({super.key});

  @override
  State<selectedCategoryForeground> createState() => _selectedCategoryForeground();
}

class _selectedCategoryForeground extends State<selectedCategoryForeground> {
